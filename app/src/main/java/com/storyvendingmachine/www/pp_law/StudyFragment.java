...
//    // TODO: Rename and change types and number of parameters
    ViewPager viewPager;
    StudySubClassViewPagerAdapter studySubClassViewPagerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        studySubClassViewPagerAdapter = new StudySubClassViewPagerAdapter(getActivity().getSupportFragmentManager());
        viewPager = (ViewPager) rootview.findViewById(R.id.studyTypeContainer);
        viewPager.setAdapter(studySubClassViewPagerAdapter);
